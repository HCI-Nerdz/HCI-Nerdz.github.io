---
title: "Context-bound settings added to the repertoire"
description: "Settings as a dependent process: a pane that follows activity state and shows only applicable controls — with essay, docs, mockups, and an interactive desk."
pubDate: 2026-08-10
draft: false
tags: ["settings", "repertoire", "demos", "docs"]
---

Context-bound settings entered the repertoire: configuration as a **dependent process** beside the activity UI, not a storage room across town.
