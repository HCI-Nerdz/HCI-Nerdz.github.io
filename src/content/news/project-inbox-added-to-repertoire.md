---
title: "Project inbox added to the repertoire"
description: "Parallel agent tasks in a scrollable grid with cosmetic fork chats — essay, docs, Dev-Centr harness contract, and an interactive desk seeded from a real Grok bot wall-of-updates."
pubDate: 2026-08-28
draft: false
tags: ["ai-assistants", "repertoire", "demos", "docs", "project-inbox", "dev-centr"]
---

Project inbox entered the repertoire: subagent work gets a glanceable task grid instead of a serialized status wall in one chat scroll.
