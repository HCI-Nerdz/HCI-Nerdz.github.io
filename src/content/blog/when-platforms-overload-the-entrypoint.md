...
description: "Cloud consoles and suite apps keep stuffing new platforms into the entrypoint header. Context rails put ecosystem nav at the edges — streets under skyscrapers — with stable color overlays so you know which world you are in."
pubDate: 2026-08-10
draft: false
...
Call the pattern **context rails**. Nav becomes substrate again.
...
![City street canyon as circulation under skyscrapers — streets as substrate](/images/context-rails/streets-as-substrate.png)
...
![Cloud-console-style header stuffed with subsection platform tabs](/images/context-rails/platforms-overload-entrypoint.png)
...
![Desktop shell with thin top and left context rails idle](/images/context-rails/rails-idle-edges.png)

![Same shell: top and left rails expanded together, same color](/images/context-rails/rails-hover-expand.png)
...
![Full-screen wireframe ecosystem navigation summoned from the rails](/images/context-rails/wireframe-ecosystem-nav.png)
...
![Three shells with distinct duo-tone platform overlays](/images/context-rails/platform-overlay-colors.png)
...
![Expanded path rails: top labels, current mark at top-left](/images/context-rails/path-edge-hover.png)
