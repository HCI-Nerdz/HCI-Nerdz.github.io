...
replacements = [
    ...
    ("when-parallel-agents-still-read-as-one-thread", "persisting-agent-work-as-a-node-graph"),
    ("when-chat-should-spawn-a-node", "persisting-agent-work-as-a-node-graph"),
    ("seeing-parallel-agents-as-a-task-grid", "persisting-agent-work-as-a-node-graph"),
